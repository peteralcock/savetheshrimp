...
/**
 * Process nonprofit description
 * 
 * @param string $description The full description
 * @param int $length The desired length in characters
...
/**
 * Format nonprofit location
 * 
 * @param string $location Location string from API
...
function enpb_format_location($location) {
    ...
    // The API might return location in different formats
    // This function could be expanded based on actual API response formats
 ...
 * Get donation URL
 * 
 * @param string $profile_url Profile URL from API
 * @return string Donation URL
 */
function enpb_get_donation_url($profile_url) {
