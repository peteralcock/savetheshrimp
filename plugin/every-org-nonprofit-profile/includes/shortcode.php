...
function enpb_nonprofit_profile_shortcode($atts) {
    ...
    if ($cached_data !== false) {
        ...
        if (json_last_error() !== JSON_ERROR_NONE || !isset($nonprofit_data['data'])) {
    ...
    $template_atts = [
        'nonprofitId' => $atts['id'],
        'name' => isset($nonprofit_data['data']['name']) ? $nonprofit_data['data']['name'] : '',
        'description' => isset($nonprofit_data['data']['description']) ? $nonprofit_data['data']['description'] : '',
        'logoUrl' => isset($nonprofit_data['data']['logoUrl']) ? $nonprofit_data['data']['logoUrl'] : '',
        'profileUrl' => isset($nonprofit_data['data']['profileUrl']) ? $nonprofit_data['data']['profileUrl'] : '',
